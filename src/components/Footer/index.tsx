...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden bg-white border-t border-slate-200">
      <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
        
        {/* */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-12 gap-10 xl:gap-8 pt-16 pb-12 lg:pt-20 lg:pb-16">
          
          {/* */}
          <div className="xl:col-span-4">
            <h2 className="mb-6 text-lg font-bold text-slate-900 tracking-wide">
              Help & Support
            </h2>

            <ul className="flex flex-col gap-4 text-sm text-slate-600">
              <li className="flex items-start gap-3.5">
                <span className="flex-shrink-0 mt-0.5 text-blue-600">
                ...
                <span className="leading-relaxed">685 Market Street,<br/>Las Vegas, LA 95820,<br/>United States.</span>
              </li>

              <li>
                <a href="mailto:support@example.com" className="flex items-center gap-3.5 transition-colors hover:text-blue-600">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-blue-600" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="flex items-center gap-3 mt-8">
              <a href="#" aria-label="Facebook" className="flex items-center justify-center w-10 h-10 rounded-full bg-slate-100 text-slate-500 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:-translate-y-1">
          ...
          <div className="xl:col-span-2">
            ...
            <ul className="flex flex-col gap-4 text-sm text-slate-600">
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/account">My Account</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/login">Login / Register</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/cart">Cart</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/wishlist">Wishlist</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/shop">Shop</Link>
              </li>
            </ul>
          </div>
          ...
          <div className="xl:col-span-2">
            ...
            <ul className="flex flex-col gap-4 text-sm text-slate-600">
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/privacy-policy">Privacy Policy</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/refund-policy">Refund Policy</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/terms">Terms of Use</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/faq">FAQ’s</Link>
              </li>
              <li>
                <Link className="inline-block transition-all duration-300 hover:text-blue-600 hover:translate-x-1" href="/contact">Contact</Link>
              </li>
            </ul>
          </div>

          {/* */}
          <div className="xl:col-span-4 xl:text-right">
            <h2 className="mb-6 text-lg font-bold text-slate-900 tracking-wide">
              Download App
            </h2>
            <p className="text-sm text-slate-600 mb-5">
              Save $3 on your first order via the app!
            </p>

            <ul className="flex flex-col sm:flex-row xl:flex-col xl:items-end gap-3">
              <li>
                <a className="inline-flex items-center gap-3 py-2.5 px-6 text-white rounded-lg bg-slate-900 transition-all duration-300 hover:bg-slate-800 hover:shadow-md hover:-translate-y-0.5" href="#">
                  <svg className="fill-current w-7 h-7" viewBox="0 0 34 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M29.5529 12.3412C29.3618 12.4871 25.9887 14.3586 25.9887 18.5198C25.9887 23.3331 30.2809 25.0358 30.4093 25.078C30.3896 25.1818 29.7275 27.41 28.1463 29.6804C26.7364 31.6783 25.264 33.6731 23.024 33.6731C20.7841 33.6731 20.2076 32.3918 17.6217 32.3918C15.1018 32.3918 14.2058 33.7152 12.1569 33.7152C10.1079 33.7152 8.6783 31.8664 7.03456 29.5961C5.13062 26.93 3.59229 22.7882 3.59229 18.8572C3.59229 12.552 7.756 9.20804 11.8538 9.20804C14.0312 9.20804 15.8462 10.6157 17.2133 10.6157C18.5144 10.6157 20.5436 9.12373 23.0207 9.12373C23.9595 9.12373 27.3327 9.20804 29.5529 12.3412ZM21.8447 6.45441C22.8692 5.25759 23.5939 3.59697 23.5939 1.93635C23.5939 1.70607 23.5741 1.47254 23.5313 1.28442C21.8645 1.34605 19.8815 2.37745 18.6857 3.74292C17.7469 4.79379 16.8707 6.45441 16.8707 8.13773C16.8707 8.39076 16.9135 8.64369 16.9333 8.72476C17.0387 8.74426 17.21 8.76694 17.3813 8.76694C18.8768 8.76694 20.7577 7.78094 21.8447 6.45441Z" fill="currentColor" />
                  </svg>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-4 flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <p className="font-semibold text-sm text-slate-700">Secure Payments:</p>
              
              <div className="flex flex-wrap items-center gap-4">
                <Image src="/images/payment/payment-01.svg" alt="Visa" width={50} height={16} className="opacity-60 transition-all duration-300 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer grayscale hover:grayscale-0" />
                <Image src="/images/payment/payment-02.svg" alt="PayPal" width={18} height={21} className="opacity-60 transition-all duration-300 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer grayscale hover:grayscale-0" />
                <Image src="/images/payment/payment-03.svg" alt="MasterCard" width={33} height={24} className="opacity-60 transition-all duration-300 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer grayscale hover:grayscale-0" />
                <Image src="/images/payment/payment-04.svg" alt="Apple Pay" width={40} height={16} className="opacity-60 transition-all duration-300 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer grayscale hover:grayscale-0" />
                <Image src="/images/payment/payment-05.svg" alt="Google Pay" width={42} height={16} className="opacity-60 transition-all duration-300 hover:opacity-100 hover:-translate-y-0.5 cursor-pointer grayscale hover:grayscale-0" />
              </div>
            </div>
