...
const Categories = () => {
  // Using 'any' here is a common workaround for Swiper's ref type, 
  // but you can type this strictly as <SwiperRef> if you import it from swiper/react
  ...
  return (
    <section className="pt-16 lg:pt-20">
      <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0 pb-16 border-b border-gray-200">
        
        {/* */}
        <div className="mb-10 flex items-end justify-between">
          <div>
            <span className="flex items-center gap-2.5 font-medium text-blue-600 mb-2 uppercase tracking-wider text-sm">
          ...
          <div className="flex items-center gap-3">
            <button 
              onClick={handlePrev} 
              className="flex items-center justify-center w-10 h-10 rounded-full border border-gray-200 text-slate-600 transition-all duration-300 hover:bg-blue-600 hover:text-white hover:border-transparent hover:shadow-md active:scale-95"
